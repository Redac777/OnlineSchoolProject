...
const SuperAdminHome = ({user,handleMainClick,year}) => {
    ...
    useEffect(() => {
    const homeItemsEng = [
        { text: "schools", linkText: "new school", linkValue: "NewSchool", icon: ecole, bgColor: `bg-violet-200`, textColor: `text-violet-800`, isHovered: false },
        { text: "posts", linkText: "new post", linkValue: "NewPost", icon: feeds, bgColor: `bg-pink-200`, textColor: `text-footerColor`, isHovered: false },
        { text: "packs", linkText: "new pack", linkValue: "NewPack", icon: plastic, bgColor: `bg-blue-300`, textColor: `text-blue-700`, isHovered: false },
      ];
      const homeItemsFr = [
        { text: "écoles", linkText: "ajouter", linkValue: "NewSchool", icon: ecole, bgColor: `bg-violet-200`, textColor: `text-violet-800`, isHovered: false },
        { text: "publications", linkText: "publier", linkValue: "NewPost", icon: feeds, bgColor: `bg-pink-200`, textColor: `text-footerColor`, isHovered: false },
        { text: "packs", linkText: "ajouter", linkValue: "NewPack", icon: plastic, bgColor: `bg-blue-300`, textColor: `text-blue-700`, isHovered: false },

      ];
      const homeItemsArabic = [
        { text: "مدارس", linkText: "إضافة", linkValue: "NewSchool", icon: ecole, bgColor: `bg-violet-200`, textColor: `text-violet-800`, isHovered: false },
        { text: "منشورات", linkText: "نشر", linkValue: "NewPost", icon: feeds, bgColor: `bg-pink-200`, textColor: `text-footerColor`, isHovered: false },
        { text: "خطط", linkText: "إضافة", linkValue: "NewPack", icon: plastic, bgColor: `bg-blue-300`, textColor: `text-blue-700`, isHovered: false },
      ...
      useEffect(() => {
        axios.get("/getSchoolCount").then((response) => {
          setSchoolCount(response.data.schoolCount);
        });
      }, []);
      useEffect(() => {
        axios.get("/getPackCount").then((response) => {
          setPackCount(response.data.packCount);
        });
      }, []);
      useEffect(() => {
