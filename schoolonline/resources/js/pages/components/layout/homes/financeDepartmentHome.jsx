...
const FinanceDepartmentHome = ({user,handleMainClick,year,schoolToEdit}) => {
    ...
    const homeItemsEng = [
        ...
        { text: "posts", linkText: "new post", linkValue: "NewFinancePost", icon: feeds, bgColor: `bg-pink-200`, textColor: `text-footerColor`, isHovered: false },
        { text: "services", linkText: "new service", linkValue: "NewService", icon: service, bgColor: `bg-blue-300`, textColor: `text-blue-700`, isHovered: false },

      ];
      const homeItemsFr = [

        { text: "publications", linkText: "publier", linkValue: "NewFinancePost", icon: feeds, bgColor: `bg-pink-200`, textColor: `text-footerColor`, isHovered: false },
        { text: "services", linkText: "ajouter", linkValue: "NewService", icon: service, bgColor: `bg-blue-300`, textColor: `text-blue-700`, isHovered: false },


      ];
      const homeItemsArabic = [

        { text: "منشورات", linkText: "نشر", linkValue: "NewFinancePost", icon: feeds, bgColor: `bg-pink-200`, textColor: `text-footerColor`, isHovered: false },
        { text: "خدمات", linkText: "إضافة", linkValue: "NewService", icon: feeds, bgColor: `bg-blue-300`, textColor: `text-blue-700`, isHovered: false },
      ...
      useEffect(() => {
        axios.get(`/getServiceCount?selectedYear=${year}&school=${schoolToEdit.id}`).then((response) => {
...
export default FinanceDepartmentHome;
