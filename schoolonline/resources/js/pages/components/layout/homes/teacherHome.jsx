...
const TeacherHome = ({user,handleMainClick}) => {
    ...
    const homeItemsEng = [
        ...
        { text: "posts", linkText: "new post", linkValue: "NewTeacherPost", icon: feeds, bgColor: `bg-pink-200`, textColor: `text-footerColor`, isHovered: false },

      ];
      const homeItemsFr = [

        { text: "publications", linkText: "publier", linkValue: "NewTeacherPost", icon: feeds, bgColor: `bg-pink-200`, textColor: `text-footerColor`, isHovered: false },


      ];
      const homeItemsArabic = [

        { text: "منشورات", linkText: "نشر", linkValue: "NewTeacherPost", icon: feeds, bgColor: `bg-pink-200`, textColor: `text-footerColor`, isHovered: false },
