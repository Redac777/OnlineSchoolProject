...
const ListTeacherPosts = ({handleMainClick,year,schoolToEdit}) => {
...
const renderPagination = () => {
    ...
    return(
        ...
        <div className="w-1/4">
        <Button svgContent={plusButtonSvg} buttonText="Add" type="button" onClick={()=>{handleMainClick("NewTeacherPost")}}/>
        </div>
        <div className="w-3/4">
            <form>
...
export default ListTeacherPosts;
