...
const ListTeacherStudents = ({handleMainClick,year,user,schoolToEdit}) => {
        ...
        <tr student="bg-white border-b">
            ...
            <td className="px-6 py-3">
                <div className="flex w-full h-full items-center">
                    <a href="#" className="font-medium text-footerColor hover:underline" onClick={()=>{handleMainClick("StudentDetails",student)}}>Details</a>
                </div>
            </td>
        </tr>
    )});
...
export default ListTeacherStudents;
