...
const ListAdministrationPosts = ({handleMainClick,year,schoolToEdit}) => {
...
const renderPagination = () => {
    ...
    return(
        ...
        <div className="w-1/4">
        <Button svgContent={plusButtonSvg} buttonText="Add" type="button" onClick={()=>{handleMainClick("NewAdministrationPost")}}/>
        </div>
        <div className="w-3/4">
            <form>
            {showSelectTeacher && (
...
export default ListAdministrationPosts;
