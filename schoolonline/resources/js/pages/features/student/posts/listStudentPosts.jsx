...
const ListStudents = ({handleMainClick,year,schoolToEdit}) => {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        axios.get(`/studentTeachers?selectedYear=${year}`).then((response) => {
    ...
    return(
        ...
        <div className="flex flex-col justify-center items-center">
            <div className="w-full flex justify-center mt-4 gap-4">
                <button className= {`bg-gray-300 px-4 py-2 rounded-lg text-slate-800 font-medium hover:bg-gray-400 ${addvalue=="administration" ? "bg-slate-400" : "bg-gray-300"}`} type="button" onClick={()=>{
                    setAddvalue("administration")}}>Administration</button>
